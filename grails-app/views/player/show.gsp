            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="player.bio.label" default="Bio" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: playerInstance, field: "bio")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="player.city.label" default="City" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="player.state.label" default="State" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: playerInstance, field: "state")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="player.website.label" default="Website" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: playerInstance, field: "website")}</td>
